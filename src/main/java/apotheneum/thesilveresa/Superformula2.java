...
public class Superformula2 extends ApotheneumPattern {
  ...
  public Superformula2(LX lx) {
    ...
    addParameter("Speed", morphSpeed);
    addParameter("Auto", autoMorph);
    addParameter("A", paramA);
    addParameter("B", paramB);
    addParameter("C", paramC);
    addParameter("D", paramD);
    addParameter("Scale", scale);
    addParameter("Rotate", rotation);
    addParameter("Width", lineWidth);
    addParameter("Sat", sat);
    addParameter("Bright", brightness);
    addParameter("Anim", animMode);
    addParameter("Rate", animRate);
  }
