...
public class LifeForms extends ApotheneumPattern {
  ...
  private final CompoundParameter rotation = new CompoundParameter("Rotation", 0.0, 0.0, 1.0)
  ...
  private final CompoundParameter tileRadParam = new CompoundParameter("TileRad", 2.5, 1.5, 6.0)
  ...
  public LifeForms(LX lx) {
    ...
    addParameter("Morph", morph);
    addParameter("ArmLen", armLen);
    addParameter("N1", n1Param);
    addParameter("N2", n2Param);
    addParameter("N3", n3Param);
    addParameter("TileRad", tileRadParam);
  }
