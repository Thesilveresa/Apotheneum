...
public class PerceptionFracture extends ApotheneumPattern {
  ...
  public PerceptionFracture(LX lx) {
    ...
    addParameter("Layers", layers);
    addParameter("Fracture", fracture);
    addParameter("Grid", gridSize);
    addParameter("Parallax", parallax);
    addParameter("Perspective", perspective);
    addParameter("Flicker", flicker);
    addParameter("Converge", convergence);
    addParameter("Invert", invertDepth);
  }
