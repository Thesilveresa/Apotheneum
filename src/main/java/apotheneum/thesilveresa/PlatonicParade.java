...
public class PlatonicParade extends ApotheneumPattern {
  ...
  public PlatonicParade(LX lx) {
    ...
    addParameter("Trace", edgeTrace);
    addParameter("Rate", edgeSpeed);
    addParameter("Bright", edgeBrightness);
    addParameter("Pulse", pulseDepth);
    addParameter("Mode", animMode);
    addParameter("Wave", waveLength);
    addParameter("Chase", chaseWidth);
    addParameter("Repeat", repeatCount);
  }
